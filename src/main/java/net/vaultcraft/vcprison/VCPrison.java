...
public class VCPrison extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        PickaxePerk.addPerk(new HastePerk(Material.DIAMOND_PICKAXE, "Haste", 5, 0, 4, "Adds a level of haste to your pick."), 2);
        ...
        SwordPerk.addPerk(new HasteSwordPerk(Material.DIAMOND_PICKAXE, "Haste", 1, 0, 2, "Adds a level of haste to your sword."), 3);
        SwordPerk.addPerk(new NightVisionSwordPerk(Material.EYE_OF_ENDER, Material.EYE_OF_ENDER, Material.ENDER_PEARL, "Night Vision", 5, false, "Adds night vision to your pick.", "Toggleable"), 4);
